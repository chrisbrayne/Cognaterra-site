...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, body, icon }) => (
  <div className="bg-white p-8 rounded-lg shadow-lg group hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
    <div className="text-brand-accent mb-4 group-hover:text-[#0D6EFD] group-hover:scale-110 transition-all duration-300">
      {icon}
    </div>
...
const Services: React.FC = () => {
  const servicesData = [
    ...
    },
    {
      ...
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M12 6V3m0 18v-3m6-6h3m-3 6h3M9 6H6m3 12H6m3-6h.01M12 12h.01M15 12h.01M12 9h.01M15 9h.01" /></svg>
    },
    {
    ...
    },
    {
      ...
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h8a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.761 14h8.478M5.282 8.036l.243.243a2 2 0 010 2.828l-1.03 1.03a2 2 0 01-2.828 0l-.243-.243a2 2 0 010-2.828l1.03-1.03a2 2 0 012.828 0zM18.718 8.036l.243.243a2 2 0 000 2.828l-1.03 1.03a2 2 0 00-2.828 0l-.243-.243a2 2 0 000-2.828l1.03-1.03a2 2 0 002.828 0z" /></svg>
    }
  ];
    ...
    <section id="services" className="py-20 bg-[#F8F9FA]">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold font-montserrat">Our Services</h2>
