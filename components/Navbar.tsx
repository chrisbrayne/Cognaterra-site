    ...
    <nav className="bg-white/80 backdrop-blur-md shadow-md fixed top-0 left-0 right-0 z-50">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          {/* Brand Name or Title instead of logo */}
          <a href="#home" className="text-2xl font-bold font-montserrat text-[#212529] group hover:text-brand-accent transition-colors duration-300">
            Cognaterra
          </a>
