  ...
  return (
    ...
    >
      <div className="py-16 text-center relative z-10">
        ...
        <a 
          href="#services"
          className="bg-[var(--color-brand-accent)] text-white font-bold font-montserrat py-3 px-8 rounded-full hover:bg-[var(--color-brand-accent-hover)] transition-all duration-300 text-lg shadow-lg transform hover:scale-105 inline-block"
        >
          Learn More
        </a>
      </div>
