...
const ServiceCard: React.FC<ServiceCardProps> = ({ title, body, icon }) => (
  <div className="bg-white p-8 rounded-lg shadow-lg group hover:shadow-xl hover:border-[var(--color-brand-accent)] border border-transparent transform hover:-translate-y-2 transition-all duration-300">
    <div className="text-[var(--color-brand-accent)] mb-4 text-5xl group-hover:text-[#0D6EFD] group-hover:scale-110 transition-all duration-300">
      {icon}
    </div>
