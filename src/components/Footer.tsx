    ...
    <footer className="bg-[#212529] text-gray-400 py-10">
      <div className="container mx-auto px-6 text-center">
        <div className="flex justify-center space-x-6 mb-6">
          <a href="#" aria-label="LinkedIn" className="text-gray-400 hover:text-[var(--color-brand-accent)] transition-colors duration-300">
          ...
          <a href="#" aria-label="Twitter" className="text-gray-400 hover:text-[var(--color-brand-accent)] transition-colors duration-300">
        ...
        <div className="flex justify-center space-x-4 text-sm">
          <a href="#" className="hover:text-[var(--color-brand-accent)] transition-colors duration-300">Privacy Policy</a>
          <span className="text-gray-600">|</span>
          <a href="#" className="hover:text-[var(--color-brand-accent)] transition-colors duration-300">Terms of Service</a>
        </div>
      </div>
    </footer>
  );
